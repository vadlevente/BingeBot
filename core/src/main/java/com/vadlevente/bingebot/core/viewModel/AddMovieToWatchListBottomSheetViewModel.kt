...
import com.vadlevente.bingebot.core.viewModel.AddMovieToWatchListBottomSheetViewModel.ViewState
        ...
        viewState.value.event?.let { event ->
            ...
            startFlow.flatMapConcat {
                ...
                .onValue {
                    onDismiss()
                    showToast(
                        message = stringOf(R.string.movieBottomSheet_movieAddedToWatchList),
                        type = INFO,
                    )
                }
        }
    ...
    fun onCreateWatchList() {
        viewModelScope.launch {
            dialogEventChannel.sendEvent(
                ShowTextFieldDialog(
                    title = stringOf(string.movieBottomSheet_createWatchListDialogTitle),
                    content = stringOf(string.movieBottomSheet_createWatchListDialogDescription),
