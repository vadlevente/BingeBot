...
class AddMovieToWatchListBottomSheetViewModel @Inject constructor(
    ...
    addItemToWatchListUseCase: AddItemToWatchListUseCase<Movie>,
    saveItemUseCase: SaveItemUseCase<Movie>,
) : AddItemToWatchListBottomSheetViewModel<Movie>(
    ...
    override fun showAddedToast(isNewlyAdded: Boolean) {
        showToast(
            message = stringOf(
                ...
                } else R.string.addMovieToWatchListBottomSheet_itemAlreadyOnWatchList
            ),
            type = INFO,
        )
    }
